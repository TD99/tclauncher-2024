...
namespace TCLauncher.Models
{
    public sealed class BackupManifest
    {
        ...
        [JsonProperty("backupId")] public Guid BackupId { get; set; }

        [JsonProperty("instanceId")] public Guid InstanceId { get; set; }
        ...
        [JsonProperty("fullInstance")] public bool FullInstance { get; set; }
    ...
    public sealed class BackupInfo
    {
        ...
        public string DisplayLabel =>
            $"{Manifest?.Name} — {Manifest?.CreatedAtUtc.ToLocalTime():g} ({(Manifest?.Automatic == true ? "automatic" : "manual")})";
    }
}