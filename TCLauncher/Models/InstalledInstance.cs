...
namespace TCLauncher.Models
{
    public class InstalledInstance : Instance
    {
        ...
        public InstalledInstance(string name, string displayName, Guid guid, string version, bool upgradeable,
            ...
            : base(name, displayName, guid, version, upgradeable, thumbnailUrl, type, mcVersion, useFabric, useForge,
                workingDirZipUrl, patches, usePatch, useIsolation, workingDirDesc, appletUrl, requirements, servers,
                minimumRamMb, maximumRamMb, jvmArguments)
        {
        ...
        public InstalledInstance(Instance instance)
            : base(instance.Name, instance.DisplayName, instance.Guid, instance.Version,
                instance.Upgradeable, instance.ThumbnailURL, instance.Type, instance.McVersion, instance.UseFabric,
                instance.UseForge, instance.WorkingDirZipURL,
                instance.Patches, instance.UsePatch, instance.UseIsolation, instance.WorkingDirDesc, instance.AppletURL,
