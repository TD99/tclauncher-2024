    ...
    public class InstalledInstance : Instance
    {
        ...
        public InstalledInstance(Instance instance)
            : base(instance.Name, instance.DisplayName, instance.Guid, instance.Version,
                   instance.Upgradeable, instance.ThumbnailURL, instance.Type, instance.McVersion, instance.WorkingDirZipURL,
                   instance.Patches, instance.UsePatch, instance.WorkingDirDesc, instance.AppletURL, instance.Requirements,
