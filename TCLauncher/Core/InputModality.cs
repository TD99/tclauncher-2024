...
namespace TCLauncher.Core
{
    public static class InputModality
    {
        ...
        private static readonly DependencyPropertyKey IsKeyboardInputPropertyKey = DependencyProperty.RegisterAttachedReadOnly(
            "IsKeyboardInput", typeof(bool), typeof(InputModality), new PropertyMetadata(false));

        public static readonly DependencyProperty IsKeyboardInputProperty = IsKeyboardInputPropertyKey.DependencyProperty;

        public static void SetIsEnabled(DependencyObject element, bool value) => element.SetValue(IsEnabledProperty, value);
        public static bool GetIsEnabled(DependencyObject element) => (bool)element.GetValue(IsEnabledProperty);
        public static bool GetIsKeyboardInput(DependencyObject element) => (bool)element.GetValue(IsKeyboardInputProperty);
        ...
        private static void OnDeactivated(object sender, System.EventArgs args) =>
            ((Window)sender).SetValue(IsKeyboardInputPropertyKey, false);
    }
}
