...
namespace TCLauncher.MVVM.View
{
    public partial class OperationCloseSheet
    {
        ...
        public OperationCloseSheet(Action<bool> exitAfterOperation, Action forceExit) { _exitAfterOperation = exitAfterOperation; _forceExit = forceExit; InitializeComponent(); }
        ...
        private void ForceExit_Click(object sender, RoutedEventArgs e) { AppServices.Overlays.Close(); _forceExit?.Invoke(); }
