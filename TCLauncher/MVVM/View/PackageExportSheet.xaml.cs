    ...
    public partial class PackageExportSheet
    {
        ...
        public PackageExportSheet(InstalledInstance instance)
        {
            ...
            ProfileDetails.Text = instance.DisplayName + "\nMinecraft " + instance.McVersion + " • " + loader.Type +
                                  (string.IsNullOrWhiteSpace(loader.Version) ? "" : " " + loader.Version) + " • pack " +
                                  instance.Version;
        }
        ...
        private void Browse_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                FileName = _instance.Name + ".tcl", DefaultExt = ".tcl",
        ...
        private async void Export_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                Status.Text = "Choose a destination first.";
                return;
            }
            ...
            var result = await AppServices.Operations.RunAsync("Exporting " + _instance.DisplayName, true,
                (progress, token) =>
                    Task.Run(
                        () => AppServices.Packages.Export(_instance, Destination.Text, IncludeSaves.IsChecked == true),
                        token));
            if (!result.IsSuccess)
            {
